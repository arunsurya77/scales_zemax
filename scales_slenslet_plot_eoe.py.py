...
for j in wave_samp:
        ...
        for i in range(1,19,1): #
            for k in range(1,18,1): #19 for full field 6 for half
                    ...
                    filename= 'scales_eoe_final/Kband_slenslet/ls_'+str(i)+'.0000'+'_'+str(k)+'.0000'+'_'+wave+'.dat'
                    print(filename)
...
#                                                    arr_y.append(np.float(result[4])*1000/18)
                                                    ...
                                                    #arr_x.append(np.float(result[3]))
                                                    #arr_y.append(np.float(result[4]))                                                    
...
plt.figure()
x=arr_x_field[ind]*3600
y=arr_y_field[ind]*3600
...
np.savetxt('pdr_k.csv',np.transpose(table),fmt='%1.4f')
